...
function Demo(sources) {
  var intent = function intent(_ref) {
    ...
    return {
      event$: _rx.Observable.merge(dom.select('#MyElement').events('pinch', options), dom.select('#MyElement').events('rotate'))
    };
  };
  ...
  var view = function view(state$) {
    ...
    return state$.map(function (state) {
      ...
      types += event.type + ' ';
      return (0, _cycleDom.div)([(0, _cycleDom.h3)('RecognizeWith cycle-hammer-driver example'), (0, _cycleDom.h4)('Events: pinch, rotate'), (0, _cycleDom.div)('#MyElement', '' + types)]);
    });
  };
