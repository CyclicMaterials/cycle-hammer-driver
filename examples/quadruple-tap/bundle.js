...
function Demo(sources) {
  var intent = function intent(_ref) {
    ...
    return {
      event$: _rx.Observable.merge(dom.select('#MyElement').events('tap', options), dom.select('#MyElement').events('quadrupletap'))
    };
  };
  ...
  var view = function view(state$) {
    ...
    return state$.map(function (state) {
      ...
      types += event.type + ' ';
      return (0, _cycleDom.div)([(0, _cycleDom.h3)('Quadruple Tap cycle-hammer-driver example'), (0, _cycleDom.h4)('Events: tap, quadrupletap'), (0, _cycleDom.div)('#MyElement', '' + types)]);
    });
  };
