...
function Demo(sources) {
  var intent = function intent(_ref) {
    ...
    return {
      events$: _rx.Observable.merge(dom.select('#MyElement').events('panleft', options), dom.select('#MyElement').events('panright'), dom.select('#MyElement').events('panup'), dom.select('#MyElement').events('pandown'), dom.select('#MyElement').events('tap'), dom.select('#MyElement').events('press'))
    };
  };

  var model = function model(actions) {
    return actions.events$.map(function (event) {
      return { event: event };
  ...
  var view = function view(state$) {
    return state$.map(function (state) {
      var type = state.event.type;

      return (0, _cycleDom.div)([(0, _cycleDom.h3)('Vertical Pan cycle-hammer-driver example'), (0, _cycleDom.h4)('Events: panleft panright panup pandown tap press'), (0, _cycleDom.div)('#MyElement', type + ' gesture detected')]);
    });
  };
...
},{"@cycle/dom":4,"rx":32}],2:[function(require,module,exports){
/**
...
var _srcMakeHammerDriver = require('./../../src/makeHammerDriver');

var _srcMakeHammerDriver2 = _interopRequireDefault(_srcMakeHammerDriver);
...
var domDriverFunc = (0, _cycleDom.makeDOMDriver)('.demo-container');

(0, _cycleCore.run)(main, {
  dom: (0, _srcMakeHammerDriver2['default'])(domDriverFunc)
});

},{"./../../src/makeHammerDriver":69,"./index":1,"@cycle/core":3,"@cycle/dom":4}],3:[function(require,module,exports){
"use strict";
...
},{"rx":32}],4:[function(require,module,exports){
"use strict";
 ...
 */
},{"./mock-dom-source":6,"./render-dom":7,"./render-html":8,"./virtual-hyperscript":10,"hyperscript-helpers":11,"virtual-dom/virtual-hyperscript/svg":54}],5:[function(require,module,exports){
"use strict";
...
},{"rx":32}],6:[function(require,module,exports){
'use strict';
...
module.exports = exports['default'];
},{"rx":32}],7:[function(require,module,exports){
"use strict";
...
},{"./fromevent":5,"./transposition":9,"./virtual-hyperscript":10,"matches-selector":12,"rx":32,"vdom-parser":13,"virtual-dom/diff":33,"virtual-dom/patch":41}],8:[function(require,module,exports){
"use strict";
...
},{"./transposition":9,"rx":32,"vdom-to-html":17}],9:[function(require,module,exports){
"use strict";
...
},{"rx":32,"virtual-dom/vnode/vnode":62}],10:[function(require,module,exports){
/* eslint-disable */
'use strict';
...
/* eslint-enable */
},{"virtual-dom/virtual-hyperscript/hooks/ev-hook.js":49,"virtual-dom/virtual-hyperscript/hooks/soft-set-hook.js":50,"virtual-dom/virtual-hyperscript/parse-tag.js":52,"virtual-dom/vnode/is-thunk":56,"virtual-dom/vnode/is-vhook":57,"virtual-dom/vnode/is-vnode":58,"virtual-dom/vnode/is-vtext":59,"virtual-dom/vnode/is-widget":60,"virtual-dom/vnode/vnode.js":62,"virtual-dom/vnode/vtext.js":64,"x-is-array":28}],11:[function(require,module,exports){
'use strict';
...
},{"./namespace-map":14,"./property-map":15,"virtual-dom/vnode/vnode":62,"virtual-dom/vnode/vtext":64}],14:[function(require,module,exports){
...
},{"./create-attribute":16,"./void-elements":27,"escape-html":18,"param-case":24,"virtual-dom/virtual-hyperscript/hooks/attribute-hook":48,"virtual-dom/virtual-hyperscript/hooks/soft-set-hook":50,"virtual-dom/vnode/is-thunk":56,"virtual-dom/vnode/is-vnode":58,"virtual-dom/vnode/is-vtext":59,"virtual-dom/vnode/is-widget":60,"xtend":25}],18:[function(require,module,exports){
/*!
 * escape-html
...
},{"min-document":29}],39:[function(require,module,exports){
"use strict";
...
},{"../vnode/is-widget.js":60,"../vnode/vpatch.js":63,"./apply-properties":42,"./update-widget":47}],46:[function(require,module,exports){
var document = require("global/document")
var isArray = require("x-is-array")
...
},{"hammerjs":31,"rx":32}],68:[function(require,module,exports){
/**
...
},{"./fromEvent":67,"./standardEventTypes":70,"rx":32}],69:[function(require,module,exports){
/**
...
},{"./hammerDriver":68}],70:[function(require,module,exports){
/**
...
exports["default"] = standardEventTypes;
module.exports = exports["default"];
